...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `default_schema`.`mGametype` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `default_schema`.`mGamedefinition` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `default_schema`.`prize` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `default_schema`.`game` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `default_schema`.`gameplayer` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `default_schema`.`dealplayer` ;
...
CREATE  TABLE IF NOT EXISTS `default_schema`.`dealplayer` (
  ...
  `dealplayercol` VARCHAR(45) NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `dealplayer_gameid_idx` (`gameid` ASC) ,
  INDEX `dealplayer_userid_idx` (`userid` ASC) ,
  CONSTRAINT `dealplayer_gameid`
    FOREIGN KEY (`gameid` )
    REFERENCES `default_schema`.`game` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `dealplayer_userid`
    FOREIGN KEY (`userid` )
    REFERENCES `default_schema`.`user` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `default_schema`.`mFormat` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `default_schema`.`prizeinventory` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `default_schema`.`mTransactiontype` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `default_schema`.`mCurrency` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `default_schema`.`useraccount` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `default_schema`.`gametransaction` ;
...
CREATE  TABLE IF NOT EXISTS `default_schema`.`gametransaction` (
  ...
  `user_id` BIGINT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `gt_gameid_idx` (`gameid` ASC) ,
  INDEX `gt_txtypeid_idx` (`txtypeid` ASC) ,
  INDEX `gt_currencyid_idx` (`currencyid` ASC) ,
  CONSTRAINT `gt_gameid`
    FOREIGN KEY (`gameid` )
    REFERENCES `default_schema`.`game` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `gt_txtypeid`
    FOREIGN KEY (`txtypeid` )
    REFERENCES `default_schema`.`mTransactiontype` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `gt_currencyid`
    FOREIGN KEY (`currencyid` )
    REFERENCES `default_schema`.`mCurrency` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `gt_userid`
    FOREIGN KEY (`user_id` )
    REFERENCES `default_schema`.`useraccount` (`user_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `default_schema`.`achievements` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `default_schema`.`category` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `default_schema`.`gift` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `default_schema`.`giftexchange` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `default_schema`.`giftinventory` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `default_schema`.`inviterequests` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `default_schema`.`rummycurrency` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `default_schema`.`transactiondetails` ;
...
-- -----------------------------------------------------
-- Table `default_schema`.`gamedealer`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `default_schema`.`gamedealer` ;

CREATE  TABLE IF NOT EXISTS `default_schema`.`gamedealer` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `gameid` BIGINT NOT NULL ,
  `matchid` INT NULL ,
  `dealid` INT NULL ,
  ...
  `gold` INT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_gamedealer_game1_idx` (`gameid` ASC) ,
  CONSTRAINT `fk_gamedealer_game1`
    FOREIGN KEY (`gameid` )
    REFERENCES `default_schema`.`game` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `default_schema`.`bot`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `default_schema`.`bot` ;

CREATE  TABLE IF NOT EXISTS `default_schema`.`bot` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `instance` INT NULL DEFAULT 0 ,
